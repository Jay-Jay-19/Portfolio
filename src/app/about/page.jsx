  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-3 xl:w-1/2">
          {/* BIOGRAPHY CONTAINER */}
          <div className="flex flex-col gap-6 sm:gap-4 xl:gap-10 justify-center">
            {/* BIOGRAPHY TITLE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3">
                  ...
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg w-fit">
                    Manager du Département Aérien
                  </div>
                  {/* COMPANY NAME */}
                  <div className="mt-4 p-1 rounded text-sm bg-black text-white w-fit">
                    Worldia
                  </div>
                  {/* COMPANY SECTOR */}
                  <div className="mt-3 text-sm italic">
                    Tour-opérateur en ligne
                  </div>
                  {/* JOB DATE */}
